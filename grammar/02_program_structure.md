...
## 2.6 들여쓰기 _indentation_: 프로그래머를 위한 규칙
...
## 2.7 빌드 - _build_: C 프로그램은 어떻게 실행 파일이 되는가
...
- **실행 파일 .exe 생성:** 최종적으로 실행 가능한 파일, windows에서는 .exe 파일을 만든다.
